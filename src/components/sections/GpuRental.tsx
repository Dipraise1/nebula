        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full py-2.5 px-4 bg-card border border-border rounded-lg focus:outline-none focus:border-primary"
                    >
                      {gpuOptions.map(gpu => (
                  ...
                  <div className="bg-card/50 rounded-lg p-4 border border-border">
                    <div className="flex justify-between mb-2">
                      <span className="text-gray-300">GPU Model:</span>
                    ...
                    <div className="flex justify-between mb-2">
                      <span className="text-gray-300">CUDA Cores:</span>
          ...
          >
            <Card className="h-full" glassEffect>
              <h3 className="text-2xl font-bold mb-6">Why Choose Nebula AI?</h3>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-semibold mb-1">On-Demand Access</h4>
                    <p className="text-gray-400">Access high-performance GPUs instantly without investing in expensive hardware.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-400">Pay only for what you use, with flexible duration options to fit your needs.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-semibold mb-1">Secure & Decentralized</h4>
                    <p className="text-gray-400">All transactions secured by blockchain technology with transparent pricing.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-semibold mb-1">Global Network</h4>
                    <p className="text-gray-400">Access GPUs from providers around the world for optimal latency and performance.</p>
                  </div>
                </div>
                
                {/* Current Usage Stats */}
                <div className="mt-6 border-t border-border pt-6">
                  <h4 className="text-lg font-semibold mb-4">Current Network Stats</h4>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-card/50 p-3 rounded-lg text-center">
                      <div className="text-2xl font-bold text-primary">2,347</div>
                      <div className="text-sm text-gray-400">Active GPUs</div>
                    </div>
                    <div className="bg-card/50 p-3 rounded-lg text-center">
                    ...
                    <div className="bg-card/50 p-3 rounded-lg text-center">
                      <div className="text-2xl font-bold text-accent">12,582</div>
                      <div className="text-sm text-gray-400">Users</div>
                    </div>
                    <div className="bg-card/50 p-3 rounded-lg text-center">
                      <div className="text-2xl font-bold text-primary">83.4K</div>
                      <div className="text-sm text-gray-400">$NAI/Day Volume</div>
                    </div>
                  </div>
                </div>
              </div>

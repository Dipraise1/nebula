    ...
    <footer className="py-12 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-1">
            ...
            >
              ...
              <p className="text-gray-400 mb-6">
                The decentralized GPU marketplace powered by $NAI token.
              </p>
              <div className="flex space-x-4">
                <a 
                  href="#" 
                  className="w-8 h-8 rounded-full bg-card flex items-center justify-center text-gray-400 hover:text-primary hover:bg-primary/10 transition-colors"
                  aria-label="Twitter"
                >
          ...
          >
            ...
            <ul className="space-y-2">
              <li><a href="#rent" className="text-gray-400 hover:text-primary transition-colors">Rent GPU</a></li>
              <li><a href="#lend" className="text-gray-400 hover:text-primary transition-colors">Lend GPU</a></li>
              <li><a href="#stake" className="text-gray-400 hover:text-primary transition-colors">Stake $NAI</a></li>
              <li><a href="#tokenomics" className="text-gray-400 hover:text-primary transition-colors">Token Economics</a></li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-primary transition-colors">Telegram</a></li>
              <li><a href="#" className="text-gray-400 hover:text-primary transition-colors">Forum</a></li>
            </ul>
          </motion.div>
        </div>
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          >
            &copy; {currentYear} Nebula AI. All rights reserved.
          </motion.p>
